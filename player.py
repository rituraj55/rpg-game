  ...
  def attack(self):
    if self.state != 'fight': print "%s swats the air, without notable results." % self.name; self.tired()
      ...
      if self.do_damage(self.enemy):
        ...
        print "Player wealth before",self.wealth
        self.wealth=self.wealth+self.enemy.wealth
        print "Enemy wealth before:",self.enemy.wealth
        self.enemy.wealth=self.enemy.wealth - 1
        print "player wealth after :",self.wealth
        print "enemy wealth after being executed:",self.enemy.wealth
        
        self.health = self.health + self.enemy.health
        self.health_max = self.health_max + self.enemy.health
